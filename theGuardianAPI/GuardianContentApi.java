...
public class GuardianContentApi {
	...
	private final static String TARGET_URL = "http://content.guardianapis.com";
	...
	public Response getContent(String query) throws UnirestException {
		...
		HttpRequest request = Unirest.get(TARGET_URL + query).queryString("api-key", apiKey).header("accept",
				"application/json");
